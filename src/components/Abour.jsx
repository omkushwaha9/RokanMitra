...
function About() {
    return (
        <div className='w-full  p-16 bg-white rounded-tl-xl rounded-tr-xl text-black'>
            ...
            <div className='w-full flex gap-32 border-t-[1px] pt-10 mt-10 border-[#a1b562]  '>
                <div className='w-1/2'>
                ...
                <div className='w-1/2 h-[50vh] mt-10 rounded-xl bg-slate-950'>
                    Image Section
                </div>
            </div>
        </div>
